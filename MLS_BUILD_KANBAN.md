...
1. Add live recorder stall/drop-frame health to extend card 12 beyond close-time/fallback metadata.
2. Validate cards 8, 9, 10, 11, 12, 13, 14, 15, and 16 in-app/on-array: OCR consensus, folder routing, sidecars, alarms, grid REC overlays, recorder fallback, late stop, false roll, setup-test sandbox, degraded TC metadata, and Finder folder opening.
3. Prepare card 17 DeckLink/RP188 capture provider once hardware is connected for certification.
