...
1. Implement card 12's independent recorder-health/fallback path.
2. Implement card 13's late-stop and false-roll flows now that lifecycle routing exists.
3. Validate cards 8, 9, 10, 14, 15, and 16 in-app/on-array: OCR consensus, folder routing, sidecars, alarms, setup-test sandbox, degraded TC metadata, and Finder folder opening.
